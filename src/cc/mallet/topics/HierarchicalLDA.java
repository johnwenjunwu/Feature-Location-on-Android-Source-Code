...
import cc.mallet.topics.tui.HierarchicalLDATUI;
...
public class HierarchicalLDA {
    ...
    public static void main(String[] args) throws IOException {
        ...
        InstanceList instances = InstanceList.load(new File("instances"));
        InstanceList testing = InstanceList.load(new File("instances"));
...
//			hlda.setEta(eta.value());
        ...
        hlda.printState(new PrintWriter("Gibbs sampling"));
